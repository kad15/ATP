...
\title
  [Optimisation de trajectoire et du temps de mission d'un drône de télécommunication multicast.]
...
\begin{frame}
  {Introduction}
  L'article présente une optimisation de trajectoire d'un drône qui doit transmettre, i.e. disséminer, i.e multicaster,
  en un minimum de temps un fichier à des récepteurs terrestres via une communication sans fil.
...
de trajectoire d'un drône équipés de système de communication sans fil
...
\begin{enumerate}
	...
	de temps minimum de connexion entre le drône et le terminal terrestre.
	\pause
